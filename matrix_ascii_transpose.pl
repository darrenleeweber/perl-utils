...
if($file){
  ...
  print STDERR ";;;\ttransposing $row rows, $col columns\n";
...
sub HELP {
	die	"\a\nUSEAGE: matrix_ascii_transpose.pl -f <file.txt> -c <cols> [-help]\n\n",

		"transpose text data matrix. All output to STDOUT.\n\n",
